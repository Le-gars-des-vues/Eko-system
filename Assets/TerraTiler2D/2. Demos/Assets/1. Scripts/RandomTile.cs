...
namespace UnityEngine.Tilemaps
{
    ...
    {
#if (UNITY_EDITOR)
        [MenuItem("Assets/Create/2D/Tiles/Random Tile", priority = 31)]
        static void CreateRandomTile()
        {
            RandomTile newTile = ScriptableObject.CreateInstance<RandomTile>();
            newTile.colliderType = ColliderType.None;

            ProjectWindowUtil.CreateAsset(newTile, "New Random Tile.asset");
        }
#endif
