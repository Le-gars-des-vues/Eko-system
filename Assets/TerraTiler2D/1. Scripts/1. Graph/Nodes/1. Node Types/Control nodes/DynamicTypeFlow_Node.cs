...
{
    public abstract class DynamicTypeFlow_Node : Flow_Node
    {
        ...
        public DynamicTypeFlow_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
