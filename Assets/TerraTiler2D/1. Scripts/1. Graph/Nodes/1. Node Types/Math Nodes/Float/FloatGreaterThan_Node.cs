...
{
    public class FloatGreaterThan_Node : Math_Node
    {
        ...
        public FloatGreaterThan_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.FloatGreaterThan;
            SetTooltip("Returns true if float A is greater than float B (A > B).");
