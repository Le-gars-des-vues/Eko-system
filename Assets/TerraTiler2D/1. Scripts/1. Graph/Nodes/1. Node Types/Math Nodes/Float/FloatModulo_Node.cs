...
{
    public class FloatModulo_Node : Math_Node
    {
        ...
        public FloatModulo_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.FloatModulo;
            SetTooltip("Returns the remainder of float A divided by float B.");
