...
{
    public class FloatAdd_Node : Math_Node
    {
        ...
        public FloatAdd_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.FloatAdd;
            SetTooltip("Adds float A to float B.");
