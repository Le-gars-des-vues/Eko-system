...
{
    public class Vector3Max_Node : Math_Node
    {
        ...
        public Vector3Max_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.Vector3Max;
            SetTooltip("Returns the Vector3 with the biggest length.");
