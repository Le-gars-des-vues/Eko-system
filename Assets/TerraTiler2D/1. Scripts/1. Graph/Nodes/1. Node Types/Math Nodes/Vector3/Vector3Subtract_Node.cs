...
{
    public class Vector3Subtract_Node : Math_Node
    {
        ...
        public Vector3Subtract_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.Vector3Subtract;
            SetTooltip("Subtracts Vector3 B from Vector3 A.");
