...
{
    public class Vector3Multiply_Node : Math_Node
    {
        ...
        public Vector3Multiply_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.Vector3Multiply;
            SetTooltip("Multiplies Vector3 A by float B.");
