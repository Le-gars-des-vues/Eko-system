...
{
    public class Vector2Min_Node : Math_Node
    {
        ...
        public Vector2Min_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.Vector2Min;
            SetTooltip("Returns the Vector2 with the shortest length.");
