...
{
    public class Vector2Divide_Node : Math_Node
    {
        ...
        public Vector2Divide_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.Vector2Divide;
            SetTooltip("Returns Vector2 A divided by float B.");
