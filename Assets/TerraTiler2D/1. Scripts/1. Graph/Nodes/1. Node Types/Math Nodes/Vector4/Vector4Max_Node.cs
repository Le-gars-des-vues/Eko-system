...
{
    public class Vector4Max_Node : Math_Node
    {
        ...
        public Vector4Max_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.Vector4Max;
            SetTooltip("Returns the Vector4 with the biggest length.");
