...
{
    public class IntEqualsOrGreaterThan_Node : Math_Node
    {
        ...
        public IntEqualsOrGreaterThan_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.IntEqualsOrGreaterThan;
            SetTooltip("Returns true if integer A is greater than or equal to integer B (A >= B).");
