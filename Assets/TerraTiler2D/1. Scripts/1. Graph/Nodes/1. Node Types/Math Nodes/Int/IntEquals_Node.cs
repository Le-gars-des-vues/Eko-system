...
{
    public class IntEquals_Node : Math_Node
    {
        ...
        public IntEquals_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.IntEquals;
            SetTooltip("Returns true if integer A is equal to integer B (A == B).");
