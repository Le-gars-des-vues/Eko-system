...
{
    public class IntMin_Node : Math_Node
    {
        ...
        public IntMin_Node(string nodeName, Vector2 position, string guid = null) : base(nodeName, position, guid)
        {
            nodeType = Glob.NodeTypes.IntMin;
        ...
        {
            return (int)Mathf.Min((int)portA.GetPortVariable(), (int)portB.GetPortVariable());
        }
    }
}
