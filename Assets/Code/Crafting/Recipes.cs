...
public class Recipes
{
    ...
    public static Dictionary<int,Recipes> listOfRecipes = new()
    {
        ...
        {28, new Recipes("Map Upgrade 2", "Waterproof Chip", 1, "Stretching Fibers", 3)},
        {29, new Recipes("Gathering Upgrade 2", "Waterproof Chip", 1, "Signal Amplifier", 2)},
        {30, new Recipes("Combat Upgrade 2", "Waterproof Chip", 1, "Reinforced Plate", 2, "Petralucen",2)},
        {31, new Recipes("Shield Upgrade 2", "Waterproof Chip", 1, "Corallium", 3, "Tentacle",5)},
        {32, new Recipes("Health Upgrade 2", "Waterproof Chip", 1, "Corallium", 3, "Fish Eyes",2)},
        {33, new Recipes("Stamina Upgrade 2", "Waterproof Chip", 1, "Tentacle", 3, "Trunk",2)},
