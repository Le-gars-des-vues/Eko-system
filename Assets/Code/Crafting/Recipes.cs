...
public class Recipes
{
    ...
    public static Dictionary<int,Recipes> listOfRecipes = new()
    {
        ...
        {7, new Recipes("Gathering Upgrade 1", "Microprocessor", 1, "Scale", 3)},
        ...
        {11, new Recipes("Stamina Upgrade 1", "Microprocessor", 1, "Lushalite", 2, "Scale", 3)},
        ...
        {30, new Recipes("Shield Upgrade 2", "Waterproof Chip", 1, "Corallium", 3, "Tentacle",2)},
