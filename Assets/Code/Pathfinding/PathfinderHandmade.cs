...
public class PathfinderHandmade
{
    ...
    public PathfinderHandmade(int width, int height)
    {
        gridMap = new GridMap<PathNode>(width, height, 10f, Vector3.zero, (GridMap<PathNode> g, int x, int y) => new PathNode(g, x, y));
    }
