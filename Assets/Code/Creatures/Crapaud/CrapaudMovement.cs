...
public class CrapaudMovement : MonoBehaviour
{
    Rigidbody2D rb;
    ...
    private void OnDrawGizmos()
    {
        ...
        //HoverCheck
        Gizmos.DrawRay(new Vector2(transform.position.x + groundCheckOffsets.x * facingDirection, transform.position.y), Vector2.down * frontRaycastLenght);
